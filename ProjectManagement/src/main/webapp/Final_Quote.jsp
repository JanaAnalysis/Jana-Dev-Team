        ...
        <div  class="card-body" >
         ...
         <legend>Final Quote PO</legend>
										   ...
										   <label class="col-md-2 control-label" >Purchase Order</label> 
												...
												<tr>
												<th class="text-center" colspan="6">Mapleton Apartment</th>
									 ...
									 <%
						                ...
						                if (!al.isEmpty()) 
						               {
								            ...
								            <tr style="background-color:<%=color%>;">
								                ...
								                <td class="text-center"><%=pList.get(9)%></td>
									  ...
									  <br>
										...
										<td><input type="date" name="date" id="date" class="form-table" maxlength="25" ></td>
										<td>
