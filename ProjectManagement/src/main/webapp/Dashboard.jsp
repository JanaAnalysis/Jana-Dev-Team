   ...
   <%-- window.onload = function () 
	{
		...
		var chart = new CanvasJS.Chart("chartContainer", {
			...
			title:{
				text: "Oncology Bar Report"
			},
			axisY: {
				title: "No of Patient's"
			},
			data: [{  
				type: "column",  
				showInLegend: true, 
				legendMarkerColor: "grey",
				legendText: "Disease Types",
				cursor:"pointer",
			    click: onClick,  
			    method:"post",
			dataPoints: [
		        ...
		        if (!al.isEmpty()) 
		       {
		            ...
		            while (itr.hasNext()) 
		            {
		                ...
		                count++;
		                ArrayList piecount = (ArrayList) itr.next();
		                
		                String test=(String)piecount.get(0);
		                co=count+1;
		                %>
				
				
		                {y:<%=piecount.get(1)%>,label: "<%=piecount.get(0)%>",link:"Barchart.jsp?diag_organ=<%=piecount.get(0)%>"}
    ...
    var chart = new CanvasJS.Chart("LinechartContainer",
    	    ...
    	    var chart = new CanvasJS.Chart("PyramichartContainer",
    	    		{
    	    			title: {
    	    		...
    	    		var chart = new CanvasJS.Chart("waterfallchartContainer", {
    	    			title: {
    	    		...
    	    		chart.render();
    	    		 ...
    	    		 var chart = new CanvasJS.Chart("cchartContainer",
    	    				    {
    	    				      title:{
    	    				    ...
    	    				    var chart = new CanvasJS.Chart("schartContainer",
    	    				    	    {
    	    				    	     title:{
...
<!--         <li class="nav-item dropdown">
  ...
  <div class="content-wrapper">
    ...
    &nbsp
     ...
     <div class="space">
     <div id="LinechartContainer" style="height: 400px; width: 100%;">
  </div> 
     ...
     <div class="space">
    <div id="PyramichartContainer" style="height: 400px; width: 100%;"></div>
   ...
   <div class="row" >
    ...
    <div class="space">
    		<div id="waterfallchartContainer" style="height: 400px; width: 100%;"></div>
    ...
    &nbsp
     ...
     <div class="space">
    		<div id="schartContainer" style="height: 400px; width: 100%;"></div>
